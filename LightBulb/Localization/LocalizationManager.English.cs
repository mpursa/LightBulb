...
public partial class LocalizationManager
{
    private static readonly IReadOnlyDictionary<string, string> EnglishLocalization =
        new Dictionary<string, string>
        {
            ...
            [nameof(ThemeSystem)] = "System theme",
            ...
            [nameof(LanguageSystem)] = "System language",
            [nameof(LanguageEnglish)] = "English",
            [nameof(LanguageUkrainian)] = "Ukrainian",
            [nameof(LanguageGerman)] = "German",
            [nameof(LanguageFrench)] = "French",
            [nameof(LanguageSpanish)] = "Spanish",
            [nameof(LanguageSimplifiedChinese)] = "SimplifiedChinese",
            [nameof(LanguageItalian)] = "Italian",
