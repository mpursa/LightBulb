...
public partial class LocalizationManager
{
    private static readonly IReadOnlyDictionary<string, string> ItalianLocalization =
        new Dictionary<string, string>
        {
            ...
            [nameof(ThemeSystem)] = "Tema di sistema",
            [nameof(ThemeLight)] = "Chiaro",
            [nameof(ThemeDark)] = "Scuro",
            ...
            [nameof(LanguageSystem)] = "Lingua di sistema",
            [nameof(LanguageEnglish)] = "Inglese",
            [nameof(LanguageUkrainian)] = "Ucraino",
            [nameof(LanguageGerman)] = "Tedesco",
            [nameof(LanguageFrench)] = "Francese",
            [nameof(LanguageSpanish)] = "Spagnolo",
            [nameof(LanguageSimplifiedChinese)] = "Cinese semplificato",
            [nameof(LanguageItalian)] = "Italiano",
